...
CREATE TABLE "User" (
    ...
    "freeImageGenerationsUsed" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "MediaGeneration" (
    ...
    "usedFreeGeneration" BOOLEAN NOT NULL DEFAULT false,
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "MediaGeneration_userId_createdAt_idx" ON "MediaGeneration"("userId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "MediaGeneration" ADD CONSTRAINT "MediaGeneration_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
